/*
  복습예제1 : 주차장 차량 검색대
    ...
    조건2 : let locationArray = [ 'AI' , 'B3' ]               :주차위치
...
let carIndex = carArray.indexOf( carNum)// 2. 입력받은 차량번호의 배열 내 인덱스 찾기
// 3. 논리조건
...
*/
/* 
  복습예제2 : 틱택토/삼목 게임 , 9칸 존재하고 연속된 3칸 만들면 승리
    - 설계  
      판넬 개수 : 9칸 판넬 필요 , 9칸 배열 생성
      판넬 상태 : B(비어있는) O(플레이어1) X(플레이어2)
    - 승리 체크
      ( 3개의 모양이 연속으로 같을 경우, B 제외)
      가로로 이기는수  : [0]==[1]==[2] , [3]==[4]==[5] , [6]==[7]==[8]  
      세로            : [0]==[1]==[2] ,[0]==[1]==[2] ,[0]==[1]==[2] ,
      대각선          : [0]==[1]==[2] ,[0]==[1]==[2] ,[0]==[1]==[2] ,
*/
...
//      1. p1입력받고 2. 승리체크 3. p2입력받고 4. 승리체크 이후 반복 (무승부까지)
