/*
  ...
  - 함수/function : 
    ...
    예) 라면 레시피
      ...
      - 면 -> 데이터
        ...
        4. 먹는다(행위)
  - 지금 사용했던 함수(미리 만들어진)함수 = 라이브러리(코드모임)
  ...
  - 선언적함수의 선언방법
    ...
    2. 함수명              : 여러 함수들을 식별하기 위한 용도(키워드x, 숫자시작x, 일부특수문자, 띄어쓰기x)
    3. (매개변수, 매개변수) : parameter / 인수 : 함수 안으로 들어가는 수, 정해져 있지 않은 수
    4. {다양한 실행코드;}   : 함수가 호출되면 실행되는 구역
    5. return              : 반환/리턴 : 함수가 종료 되면서 *함수가 호출했던 곳으로 수 반환
